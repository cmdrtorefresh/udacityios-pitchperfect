...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    func configureUI(playState: PlayingState) {
        ...
        case .Playing:
            ...
            stopBtnOutlet.enabled = true
        case .NotPlaying:
            setPlayButtonsEnabled(true)
            stopBtnOutlet.enabled = false
        }
    }
    
    func setPlayButtonsEnabled(enabled: Bool) {
        snailBtnOutlet.enabled = enabled
        chipmunkBtnOutlet.enabled = enabled
        rabbitBtnOutlet.enabled = enabled
        darthVaderBtnOutlet.enabled = enabled
        echoBtnOutlet.enabled = enabled
        reverbBtnOutlet.enabled = enabled
    }
